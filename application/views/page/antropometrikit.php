...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets') ?>/css/antropometrikit.css">
                    ...
                    <div class="card-mobile pt-2">
                        <div class="col">
                            ...
                            <div class="card bg-gradient-grey border-0 rounded-xl">
                                <div class="pl-3 pr-3 pt-3 mb-0">
                                    <img class="w-80" src="<?= base_url('assets') ?>/img/model-brand-mobile.png" alt="" style="margin-left: 22px;">
                                </div>
                            </div>
                        </div>
                    </div>
